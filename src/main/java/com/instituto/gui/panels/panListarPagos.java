 ...
 * @author root
 */
public class panListarPagos extends javax.swing.JPanel {
     ...
     */
    public panListarPagos(ControladorDetallePagos cdp, ControladorAlumno ca) {
        this.cdp= cdp;
        this.ca= ca;
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Detalle", "Mes", "Alumno", "Monto", "Fecha"
            }
        ) {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        List <DetallePagos> l = null;
        if(txtIdAlumno.getText().length() == 10 && txtIdMes.getText().length() == 6) {
            l= cdp.listarDetallePagos(
                    ca.buscarAlumno(txtIdAlumno.getText()), 
                    txtIdMes.getText());
        } else if(txtIdAlumno.getText().length() == 10) {
            l= cdp.listarDetallePagos(ca.buscarAlumno(txtIdAlumno.getText()));
        }
        if(l != null) {
            dtm.setRowCount(0);
            for (DetallePagos dp : l) {
                dtm.addRow(new Object[]{dp.getIdDetalle() , dp.getIdMes(),
                dp.getIdAlumno().getIdAlumno(), dp.getMonto(), dp.getFecha()});
            }
        }
