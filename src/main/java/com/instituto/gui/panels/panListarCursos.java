 ...
 * @author root
 */
public class panListarCursos extends javax.swing.JPanel {
     ...
     */
    public panListarCursos(ControladorNombreCurso cc, ControladorEspecialidad ce) {
        this.cc= cc;
        this.ce= ce;
        initComponents();
    ...
    private void listarCursos(String nomb) {
        ...
        for (NombreCurso nc : cursos) {
            ...
            if(nombre.toLowerCase().startsWith(nomb.toLowerCase())) {
                Especialidad e= ce.buscarEspecialidad(nc.getIdEspecialidad().getIdEspecialidad());
                String ne= e.getNombre();
                Object rw[]= new Object[]{nc.getIdNombreCursos(), nombre, ne};
                dtm.addRow(rw);
            }
        }
    }
