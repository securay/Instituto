 ...
 * @author root
 */
public class panListarPeriodos extends javax.swing.JPanel {
     ...
     */
    public panListarPeriodos(ControladorPeriodo cp) {
        this.cp= cp;
        initComponents();
        dtm= (DefaultTableModel)tabla.getModel();
        actualizarListaPeriodos();
    }
    
    private void actualizarListaPeriodos() {
        periodos= cp.listarPeriodo();
        listarPeriodos("");
    }
    
    private void listarPeriodos(String nomb) {
        dtm.setRowCount(0);
        for (Periodo p : periodos) {
            String codigo= p.getIdPeriodo();
            if(codigo.toLowerCase().startsWith(nomb.toLowerCase())) {
                Object rw[]= new Object[]{codigo, p.getFechaInicio(),p.getFechaFin()};
                dtm.addRow(rw);
            }
        }
    }
    ...
    private void txtNombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyReleased
        ...
        listarPeriodos(txtNombre.getText());
